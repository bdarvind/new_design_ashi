...
AND creation_time <= '".$todate." 00:00:00') AND purpose='aadhaar_withdrawl' ORDER BY id DESC");
}else{
    $sqltran = mysqli_query($conn,"select * from csp_wallet_txn where csp_id_fk ='".$_SESSION['csp']."' AND purpose='aadhaar_withdrawl' ORDER BY id DESC");
}
                            ...
                            <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Customer: activate to sort column ascending" style="width: 68.2969px;">Transaction Type</th>
                                        ...
                                        <!-- <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 113.344px;">GST</th> -->
