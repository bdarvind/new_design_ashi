...
AND creation_time <= '".$todate." 00:00:00') AND purpose='cash_withdrawl' ORDER BY id DESC");
}else{
    $sqltran = mysqli_query($conn,"select * from csp_wallet_txn where csp_id_fk ='".$_SESSION['csp']."' AND purpose='cash_withdrawl' ORDER BY id DESC");
}
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="card">
              <div class="card-body">
            <h4 class="card-title">Cash Withdrawals</h4>
