...
$user_id = encryption('decrypt',$_GET['token']);
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title><?php echo $nb_user['member_name']; ?> - Mini-Statement</title>
  ...
  <body>
    ...
    <div class="w3-content w3-container ">
      <div class="w3-bar w3-margin-bottom">
        ...
        <a onclick="printpage()" id="print_btn" class="w3-btn w3-bar-item w3-right w3-green w3-round">Print Certificate</a>
      </div>
        ...
        $nb_id = $user_id;
        $i = 1;
          $nb_txn = mysqli_query($conn, "SELECT * FROM nb_user_txn WHERE nb_id_fk='$nb_id' ORDER BY id DESC LIMIT 10");
          while ($txn = mysqli_fetch_assoc($nb_txn)) {
            ...
            <tr>
              ...
              <td>".$txn['type']."</td>
              <td>".$txn['txn_id']."</td>
              <td>".$txn['note']."/".$txn['bene_upi_id']."</td>
