...
AND creation_time <= '".$todate." 00:00:00') AND purpose='commission' ORDER BY id DESC");
}else{
    $sqltran = mysqli_query($conn,"select * from csp_wallet_txn where csp_id_fk ='".$_SESSION['csp']."' AND purpose='commission' ORDER BY id DESC");
}
