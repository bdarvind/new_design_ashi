...
<?php else: ?>
    <div class="w3-section w3-margin">
      <h4><b>Click here for Balance Enquiry</b></h4>
      <?php $bq_text = "Balance In User Account - ₹".$get_user['account_balance']; ?>
      <a onclick="sweetalert('Successfully Fetched','success','balance-enquiry.php','<?php echo $bq_text; ?>');" class="w3-btn w3-green w3-round"><i class="fas fa-plus-circle"></i> Balance Enquiry</a>
