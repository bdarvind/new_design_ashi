...
<?php else: ?>
    <div class="w3-section w3-margin">
      <h4><b>Click Here to Add Funds</b></h4>
      <a onclick="toggle_show('cd_form_modal');data_to_id('nb_id_add_funds',<?php echo $get_user['id']; ?>);" class="w3-btn w3-green w3-round"><i class="fas fa-plus-circle"></i> Cash Deposit</a>
    </div>
