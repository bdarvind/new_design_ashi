...
<html>
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="includes/homecss/materialdesignicons.min.css">
    <link rel="stylesheet" href="includes/homecss/vendor.bundle.base.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="includes/homecss/font-awesome.min.css" />
    <link rel="stylesheet" href="includes/homecss/bootstrap-datepicker.min.css">
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="includes/homecss/style.css">
    <!-- End layout styles -->
